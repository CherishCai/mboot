...
//    }
    ...
    private static final String SWAGGER_SCAN_BASE_PACKAGE = "cn.cherish.mboot.web.controller";
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .description("更多内容请关注：http://www.caihongwen.cn")
                .version(VERSION)
                .contact(
                        new Contact("Cherish","www.caihongwen.cn","785427346@qq.com")
                )
                .termsOfServiceUrl("www.caihongwen.com")
                .build();
    }
