...
public class JsApiPay {
	...
	public void GetOpenidAndAccessToken() throws Exception {
		...
		if (code != null && !code.isEmpty()) {
			...
			//String host="http://pay.guangzhouhr.com"+request.getServletPath();
			String host=WxPayConfig.redirect_url;
	...
	public void GetOpenidAndAccessTokenFromCode(String code) throws WxPayException {
		try {
	 ...
	 * http://pay.weixin.qq.com/wiki/doc/api/jsapi.php?chapter=7_9
