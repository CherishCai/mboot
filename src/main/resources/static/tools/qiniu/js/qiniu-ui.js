...
FileProgress.prototype.setComplete = function(up, info) {
    ...
    var showImg = $('<img src="/static/tools/qiniu/images/loading.gif"/>');

    progressNameTd.append(Wrapper);

    if (!isImg) {
        showImg.attr('src', '/static/tools/qiniu/images/default.png');//上传失败默认显示的图片
        ...
        $(img).on('load', function() {
            ...
            function initImg(url, key, height) {
                ...
                modalBody.find('img').attr('src', '/static/tools/qiniu/images/loading.gif');
            ...
            fopLink.on('click', function() {
                ...
                fopArr.push({
                    fop: 'watermark',
                    // mode: 1,
                    // image: 'https://www.caihongwen.cn/static/image/myself.jpg',//水印图片
                    mode: 2,  // 文字水印
            ...
            showImg.attr('src', '/static/tools/qiniu/images/default.png');
            Wrapper.addClass('default');
        });
    }
};
